...
<div class="wrapper">
            ...
            <ul class="nav nav-treeview">              
              <li class="nav-item">
                <a href="{{route('create-activites')}}" class="nav-link">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Nouvelle activitée</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{route('view-activites')}}" class="nav-link">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Activités enregistrées</p>
                </a>
              </li>
            </ul>
          </li>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; {{ date('Y') }} <a href="">KBT ingénierie</a>.</strong>
    Tout droit reservé.
