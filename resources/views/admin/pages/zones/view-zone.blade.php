                  ...
                  <tbody>                    
                    @foreach ($zone_items as $item)                 
                        <tr style="font-size: 85%">
                          ...
                          <td>{{$item->nom}}</td>
                          <td>{{$item->collecteurs->nomcollecteur." ".$item->collecteurs->prenomcollecteur }}</td>                           
                          <td>                      
                            <a href="{{route('edit.zone', ['zone'=>$item->id]) }}" class="btn btn-success btn-sm"><span class="fa fa-edit"></span></a>
